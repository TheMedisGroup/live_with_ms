  ...
  render: function() {
    return (
      <div className="container" id="about-view">
        ...
        <li>css modules provided by <a target="_blank" href="http://getbootstrap.com/">bootstrap css</a></li>
        ...
        <li>coded by Michael Medis (<a href="https://github.com/theMedisGroup/">theMedisGroup</a>) with Ricky Panzer @ <a href="http://bloc.io">BLOC</a></li>
        ...
        <p></p>
          <img className="marvelimgs" src="https://i.imgur.com/Xg3ejh7.png" />
      </div>
    );
  }
});
